...
export default function AddCollectionPage() {
  ...
  const [items, setItems] = useState<LineItem[]>([
    ...
    createLineItem("Thu phí vận chuyển hàng hóa", 20000000),
  ]);

  const [voucherTitle, setVoucherTitle] = useState(
    "Thu tiền hợp đồng số 12345"
  );
  ...
  const [bankNote, setBankNote] = useState(
    "Thanh toán chuyển khoản, nội dung: Thu tiền hợp đồng số 12345."
  );
...
function Stepper({ step }: { step: 1 | 2 | 3 }) {
  const items = [
    ...
    { id: 2, label: "Thông tin mục đích thu" },
    { id: 3, label: "Xác nhận" },
  ];
        ...
        <CardContent className="space-y-1">
          <div className="space-y-1">
            ...
            <Input
              ...
              className="h-9"
              placeholder="Ví dụ: Thanh toán tiền mua vật tư, thu phí vận chuyển..."
            />
          </div>
          <div className="space-y-1 md:col-span-1">
            ...
            <Textarea
              ...
              placeholder="Mô tả thu tiết nội dung thu tiền..."
            />
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="text-sm">
              <span className="mr-2 text-muted-foreground">Tổng tiền thu</span>
              ...
              <div>
                ...
                <Select value={method} onValueChange={setMethod}>
                  <SelectTrigger className="mt-1 h-9">
                    <SelectValue placeholder="Chọn hình thức thu" />
                  </SelectTrigger>
                  <SelectContent>
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-base font-semibold">
            Danh sách chứng từ thu
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 text-sm">
          <div className="space-y-2 rounded-lg border bg-muted/30 p-3">
            <p className="font-semibold text-foreground">Khoản thu</p>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-1">
              ...
              <p>
                Số phiếu thu: <span className="font-semibold">{voucherNo}</span>
              </p>
              <p>
                Ngày lập chứng từ:{" "}
                <span className="font-semibold">
              ...
              {bank ? (
                <div className="flex items-start gap-3 rounded-lg border bg-muted/40 p-3 text-xs">
                  ...
                  <div className="flex flex-col gap-0.5">
                    ...
                    <p className="text-muted-foreground">
                      <span className="font-medium">Thu nhánh:</span>{" "}
                      {bank.branch}
                    </p>
                    {bankNote && (
                      <p className="text-muted-foreground">
